...
public class ReceiveLogsTopic01 {
    ...
    public static void main(String[] args) throws IOException, TimeoutException {
        ...
        for (String routingKey : routingKeys) {
            ...
            System.out.println("ReceiveLogsTopic01 exchange:"+EXCHANGE_NAME+", queue:"+queueName+", BindRoutingKey:" + routingKey);
        }

        System.out.println("ReceiveLogsTopic01 [*] Waiting for messages. To exit press CTRL+C");

        DefaultConsumer consumer = new DefaultConsumer(channel) {
            @Override
            public void handleDelivery(String consumerTag, Envelope envelope, AMQP.BasicProperties properties, byte[] body) throws IOException {
                String message = new String(body, "UTF-8");
                System.out.println("ReceiveLogsTopic01 [x] Received '" + envelope.getRoutingKey() + "':'" + message + "'");
            }
        };
